...
#   timestamp: 2024-10-29T09:05:24+00:00
...
class DeviceCapabilities:
    ...
    versionedExpirationTimer: Optional[bool] = None
...
class TransferArchiveUploadedRequest:
    ...
    """
    transferArchive: Optional[RemoteAttachment] = None
...
class KeyTransparencyDistinguishedKeyResponse:
    distinguishedKeyResponse: str
    """
    The response for the distinguished tree head encoded in standard un-padded base64
    """
...
class KeyTransparencyMonitorResponse:
    monitorResponse: str
    """
    The monitor response encoded in standard un-padded base64
    """
...
class KeyTransparencySearchResponse:
    aciSearchResponse: str
    """
    The search response for the aci search key encoded in standard un-padded base64
    """
    e164SearchResponse: Optional[str] = None
    """
    The search response for the e164 search key encoded in standard un-padded base64
    """
    usernameHashSearchResponse: Optional[str] = None
    """
    The search response for the username hash search key encoded in standard un-padded base64
    """
