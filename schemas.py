...
#   timestamp: 2025-06-18T06:06:47+00:00
...
class Capability(Enum):
    ...
    SPARSE_POST_QUANTUM_RATCHET = "SPARSE_POST_QUANTUM_RATCHET"
...
@dataclass
class MismatchedDevicesResponse:
...
class PhoneNumberIdentityKeyDistributionRequest:
    ...
    """
    devicePniPqLastResortPrekeys: Dict[str, KEMSignedPreKey]
    """
...
class RestoreAccountRequest:
    ...
    The method by which the new device has requested account data restoration
    """
    deviceTransferBootstrap: Optional[str] = None
    """
...
class SetKeysRequest:
    ...
    """
    pqPreKeys: List[KEMSignedPreKey]
    """
...
@dataclass
class SendMultiRecipientMessageResponse:
    uuids404: Optional[List[str]] = None
    """
...
class AccountMismatchedDevices:
    ...
    A service identifier is a tuple of a UUID and identity type that identifies an account and identity within the Signal service.
    """
    devices: Optional[MismatchedDevicesResponse] = None
...
class AccountStaleDevices:
    ...
    A service identifier is a tuple of a UUID and identity type that identifies an account and identity within the Signal service.
    """
    devices: Optional[StaleDevicesResponse] = None
...
class AccountCreationResponse:
    ...
    reregistration: Optional[bool] = None
    """
...
class ChangeNumberRequest:
    ...
    pniRegistrationIds: Dict[str, int]
    """
    the new phone-number-identity registration ID for each device on the account, including this one
    """
    sessionId: Optional[str] = None
    """
